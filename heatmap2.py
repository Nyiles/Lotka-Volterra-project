# -*- coding: utf-8 -*-
"""
Created on Fri May  3 13:36:55 2024
...
y20 = 2  # Initial population of predator 2
y0 = [x0, y10, y20]
...
def update(frame):
    ...
    global prev_value 
    if int(g2[frame]) < int(prev_value):
        data.fill(0)
        
    if frame % 2 == 0:
        for i in range(0, 1+int(g2[frame]/16)):
            for j in range(0, 1+int(int(g2[frame])%16)):
                data[i, j] = 0.3
